...
int main() {
    ...
    double X_w_leftbelow = 2824.0;
    double Y_w_leftbelow = 703.0;
    double Z_w_leftbelow = 25591.0;
    Pw_leftbelow << X_w_leftbelow, Y_w_leftbelow, Z_w_leftbelow, 1.0; // 示例点 (X_w, Y_w, Z_w, 1)

    Eigen::Vector4d Pw_leftup;
    double X_w_leftup = 2824.0;
    double Y_w_leftup = 1383.0;
    double Z_w_leftup = 25591.0;
    Pw_leftup << X_w_leftup, Y_w_leftup, Z_w_leftup, 1.0;

    Eigen::Vector4d Pw_rightbelow;
    double X_w_rightbelow = 3626.0;
    double Y_w_rightbelow = 703.0;
    double Z_w_rightbelow = 25591.0;
    Pw_rightbelow << X_w_rightbelow, Y_w_rightbelow, Z_w_rightbelow, 1.0;

    Eigen::Vector4d Pw_rightup;
    double X_w_rightup = 3626.0;
    double Y_w_rightup = 1383.0;
    double Z_w_rightup = 25591.0;
...
//     t << 0, 0, 0; // 示例平移向量
    ...
    // 定义相机内参矩阵 K (3x3)
    Eigen::Matrix3d K; //选择的相机MV-CA016—10UC中的像元尺寸为3.45um*3.45um，这里单位是mm
